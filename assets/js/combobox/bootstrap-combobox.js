...
!function( $ ) {
 ...
 "use strict"
  ...
  template: '<div class="combobox-container"><input class="input-medium" type="text" autocomplete="off" /><span class="add-on btn dropdown-toggle" data-dropdown="dropdown"><span class="caret"/><span class="combobox-clear"><i class="icon-remove"/></span></span></div>'
