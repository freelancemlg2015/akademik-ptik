...
class Penasehat_akademik_model extends CI_Model {
    ...
    function s_penasehat_akademik() {
        return $this->db->select('t_penasehat_akademik.*,m_angkatan.kode_angkatan,m_jenjang_studi.jenjang_studi')
                        ->from('t_penasehat_akademik')
                        ->join('m_angkatan', 'm_angkatan.id = t_penasehat_akademik.angkatan_id', 'left')
                        ->join('m_jenjang_studi', 'm_jenjang_studi.id = t_penasehat_akademik.jenjang_studi', 'left');
    }
