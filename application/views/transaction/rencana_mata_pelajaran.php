...
<div class="container-fluid form-inline well" id="rencana_mata_pelajaran-search">
    <?php
...
<table class="table table-bordered table-striped container-full data_list" id="rencana_mata_pelajaran" controller="transaction">
    <thead>
        <tr>
            <th>Angkatan</th>
