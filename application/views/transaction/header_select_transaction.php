...
?>
    ...
    <div class="control-group">
        ...
        <div class="controls">
			<?= form_dropdown('tahun_akademik_id', $tahun_akademik_options, set_value('tahun_akademik_id', $tahun_akademik_id), 'id="tahun_akademik_id" class="input-medium" prevData-selected="' . set_value('tahun_akademik_id', $tahun_akademik_id) . '"') . '&nbsp;&nbsp;'; ?>
    ...
    <div class="control-group">
        ...
        <div class="controls">
			<?= form_dropdown('semester_id', $semester_options, set_value('semester_id', $semester_id), 'id="semester_id" class="input-medium" prevData-selected="' . set_value('semester_id', $semester_id) . '"') . '&nbsp;&nbsp;'; ?>
