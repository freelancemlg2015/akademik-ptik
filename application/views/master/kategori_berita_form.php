...
$kategori_berita_attr = array(
    ...
    'class' => 'input-medium',
    'value' => set_value('kategori_berita', $kategori_berita),
    'autocomplete' => 'off'
);
...
?>
<div class="container-full" id="kategori_berita">
    <?= form_open($action_url, array('class' => 'form-horizontal')); ?>

    <div class="control-group">
        <?= form_label('Kategori Berita' . required(), 'kategori_berita', $control_label); ?>
        <div class="controls">
            <?= form_input($kategori_berita_attr) ?>
            <p class="help-block"><?php echo form_error('kategori_berita') ?></p>
        </div>
    </div>
