...
<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container">
            <a href="#" class="brand">STIK-AKADEMIK App&trade;</a>
            <ul class="nav">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li class="dropdown <?= ($secondary_nav == 'program_studi' || $secondary_nav == 'tahun_akademik' || $secondary_nav == 'kelompok_matakuliah' || $secondary_nav == 'matakuliah' || $secondary_nav == 'jenjang_studi' || $secondary_nav == 'frekuensi_pemutakhiran' || $secondary_nav == 'pelaksana_pemutakhiran' || $secondary_nav == 'angkatan') ? 'active' : ''; ?>">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="<?= isActive($secondary_nav, 'kelompok_mata_kuliah'); ?>"><?= anchor('master/kelompok_mata_kuliah', 'Kelompok Mata kuliah'); ?></li>
    ...
    case 'transaction':
            ...
            <div class="subnav subnav-fixed">
                <ul class="nav nav-pills">
                    ...
                    <li class="dropdown <?= ($secondary_nav == 'pake_matakuliah' || $secondary_nav == 'kalender_akademik') ? 'active' : ''; ?>">
                        <a href="#" data-toggle="dropdown" class="dropdown-toggle">Kurikulum<b class="caret"></b></a>
                        <ul class="dropdown-menu">                      
                    ...
                    <li class="dropdown <?= ($secondary_nav == 'jadwal_kuliah' || $secondary_nav == 'ujian_skripsi' || $secondary_nav == 'plot_kelas' || $secondary_nav == 'plot_dosen_ajar' || $secondary_nav == 'absensi_mahasiswa' || $secondary_nav == 'absensi_dosen') ? 'active' : ''; ?>">
                    ...
                    <li class="dropdown <?= ($secondary_nav == 'nilai_akademik' || $secondary_nav == 'nilai_fisik' || $secondary_nav == 'nilai_mental') ? 'active' : ''; ?>">
        ...
        case 'laporan':
            ...
            <div class="subnav subnav-fixed">           
                <ul class="nav nav-pills">
                    <li class="<?= isActive($secondary_nav, 'sample'); ?>"><?= anchor('master/sample', 'Sample'); ?></li>
                </ul>
            </div>
            <?php
            break;
