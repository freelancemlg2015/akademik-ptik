...
<div class="container-full" id="jadwal_kuliah">
    ...
    <div class="control-group">
        ...
        <div class="controls">
			<?= form_dropdown('semester_id', $semester_options, set_value('semester_id', $semester_id), 'id="semester_id" onChange="programStudiChange()" class="input-medium" prevData-selected="' . set_value(
    ...
    <div class="control-group">
        <?= form_label('Nama Kegiatan', 'nama_kegiatan_attr', $control_label); ?>
        <div class="controls">
			<?= form_input($nama_kegiatan_attr) ?>
            <p class="help-block"><?php echo form_error('nama_kegiatan_attr') ?></p>
        </div>
    </div>
