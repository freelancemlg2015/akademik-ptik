...
<div class="container-fluid form-inline well" id="plot_dosen_penanggung_jawab-search">
    <?php
...
<table class="table table-bordered table-striped container-full data_list" id="plot_dosen_penanggung_jawab" controller="transaction">
    <thead>
        <tr>
            <th>Angkatan</th>
            <th>Semester</th>  
