...
// set document information
	    ...
	    $pdf->MultiCell(200, 15, "DAFTAR MAHASISWA PTIK\nANGKATAN ".$kode_angkatan, 0, 'C', 1, 0, '', '', true, 0, false, true, 15, 'M');
...
$table_header = '
	<table border = "1">
		...
		$table .= '<tr>
			...
			&nbsp;<br/>'.$row->nama_pangkat.(!empty($row->nrp)?" / ".$row->nrp:"").'
			</td>
